                ...
                <div class="listCourse">
                    <table>
                        ...
                        <tr v-for="user in listUser" v-bind:key="user.id">
                            ...
                            <td>{{user.username}}</td>
                            <td>
                                <p id="delete" v-on:click="deleteUser(user.id)">Xóa</p>
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    ...
    methods:{
        async deleteUser(id){
            let data = await axios.delete('http://localhost:8080/api/delete-a-user', {
                data: {
                    id: id
                }
            });
            if(data.data.message == 'Deleted user'){
                let listUser = await axios.get('http://localhost:8080/api/get-user');
                this.listUser = listUser.data.data;
